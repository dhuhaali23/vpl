...
import { Instructions4 } from './instructions4';
...
const Workspace4 = (props) => {
    ...
    const {
        ...
        setInductionFactor, inductionFactor,
    } = GlobalStore();
    ...
    return (
        <div className='select-none'>
            {contextHolder}
            <Instructions4 ShowInstructions={ShowInstructions} setShowInstructions={setShowInstructions} />
            <ReactFlowProvider>
                <div className='flex flex-col justify-start  items-center' >
                        ...
                        <div className='flex justify-between items-center h-full '>
                            ...
                            <div className='flex justify-between items-center' >
                                ...
                                <Button
                                    ...
                                    onClick={() => navigate({
                                        pathname: '/quiz',
                                        search: `?${createSearchParams({ exp: 3 })}`
                                    })}
                    ...
                    {
                        SelectedItem.nodes.length > 0 && (SelectedItem.nodes[0].id == 'ACSourceId1' || SelectedItem.nodes[0].id == 'InductorId1') ? (
                            <div
                            ...
                            >
                                {
                                    SelectedItem.nodes[0].id == 'InductorId1' ? (
                                        <>
                                            <div>
                                                <Divider style={{ margin: '5px 0px', fontWeight: 'bold' }} orientation='left' >الملف</Divider>
                                            </div>
                                            <div
                                            ...
                                            >
                                                <Checkbox
                                                    ...
                                                    defaultChecked={inductionFactor === 1 ? false : true}
                                                    checked={inductionFactor === 1 ? false : true}
                                                    onChange={(e) => {
                                                        setInductionFactor(e.target.checked === true ? 2 : 1);
                                                        if (Run) {
