...
import { Instructions5 } from './instructions5';
...
const Workspace5 = (props) => {
    ...
    return (
        <div className='select-none'>
            {contextHolder}
            <Instructions5 ShowInstructions={ShowInstructions} setShowInstructions={setShowInstructions} />
            <ReactFlowProvider>
                        ...
                        <div className='flex justify-between items-center h-full '>
                            ...
                            <div className='flex justify-between items-center' >
                                ...
                                <Button
                                    ...
                                    onClick={() => navigate({
                                        pathname: '/quiz',
                                        search: `?${createSearchParams({ exp: 4 })}`
                                    })}
